! function (t) {
    ...
    var i = s(1),
        ...
        n = function () {
            function t(e) {
                void 0 === e && (e = {});
                var s = this;
                if (this.calendar = {}, this.states = {}, this.intervalRange = {}, this.daysSelected = [], this.options = a.Utilities.extend(e), this.selector = "string" == typeof this.options.selector ? document.querySelector(this.options.selector) : this.options.selector, null === this.selector) throw new Error("You need to specify a selector!");
            ...
            return Object.defineProperty(t, "cssClasses", {
                ...
                this.states.isMultiplePick = t
            }, t.prototype.setDisablePastDays = function (t) {
                this.states.isDisablePastDays = t
            }, t.prototype.setTodayHighlight = function (t) {
                this.states.isTodayHighlight = t
            }, t.prototype.setRange = function (t) {
                this.states.isRange = t
            }, t.prototype.setLocked = function (t) {
                this.states.isLocked = t
            }, t.prototype.init = function (t) {
                this.todayDate = new Date, this.todayDate = this.todayDate.setHours(0, 0, 0, 0), this.date = new Date, this.defaultDate = new Date, this.options.defaultDate && (this.date = new Date(this.options.defaultDate), this.defaultDate = new Date(this.options.defaultDate), this.defaultDate.setDate(this.defaultDate.getDate())), this.date.setDate(1), this.options.minDate && (this.minDate = new Date(this.options.minDate), this.minDate.setHours(0, 0, 0, 0), this.minDate.setDate(this.minDate.getDate() - 1)), this.options.maxDate && (this.maxDate = new Date(this.options.maxDate), this.maxDate.setHours(0, 0, 0, 0), this.maxDate.setDate(this.maxDate.getDate() + 1)), this.mounted(), this.options.onLoad.call(this), t && t.call(this)
                ...
                for (var s = 0, i = Object.keys(this.daysOfMonth); s < i.length; s++) {
                    var a = i[s];
                    this.handleClickInteraction(this.daysOfMonth[a], e), this.states.isRange && this.handleMouseInteraction(this.daysOfMonth[a])
                }
            }, t.prototype.getIntervalOfDates = function (t, e) {
                for (var s = [], i = t, a = function (t) {
                        var e = new Date(this.valueOf());
                        return e.setDate(e.getDate() + t), e.getTime()
                    }; i <= e;) s.push(i), i = a.call(i, 1);
                return s
            }, t.prototype.handleClickInteraction = function (e, s) {
                var i = this;
                e.addEventListener("click", function (e) {
                    var n = a.Utilities.getIndexForEventTarget(i.daysOfMonth, e.target);
                    i.days[n].isLocked || (i.lastSelectedDay = i.days[n].timestamp, i.states.isRange || (i.states.isMultiplePick ? (i.days[n].timestamp && (i.daysSelected = i.daysSelected.filter(function (t) {
                        return t !== i.lastSelectedDay
                    })), i.days[n].isSelected || i.daysSelected.push(i.lastSelectedDay)) : (i.days[n].isLocked || i.removeStatesClass(), i.daysSelected = [], i.daysSelected.push(i.lastSelectedDay))), a.Utilities.toggleClass(e.target, t.cssStates.IS_SELECTED), i.days[n].isSelected = !i.days[n].isSelected, i.states.isRange && (i.intervalRange.begin && i.intervalRange.end && (i.intervalRange.begin = void 0, i.intervalRange.end = void 0, i.removeStatesClass()), i.intervalRange.begin && !i.intervalRange.end && (i.intervalRange.end = i.days[n].timestamp, i.daysSelected = i.getIntervalOfDates(i.intervalRange.begin, i.intervalRange.end), a.Utilities.addClass(e.target, t.cssStates.IS_END_RANGE), i.intervalRange.begin > i.intervalRange.end && (i.intervalRange.begin = void 0, i.intervalRange.end = void 0, i.removeStatesClass())), i.intervalRange.begin || (i.intervalRange.begin = i.days[n].timestamp), a.Utilities.addClass(e.target, t.cssStates.IS_SELECTED)), i.options.onSelect.call(i), s && s.call(i))
                })
                ...
                this.days = this.days || {}, n.textContent = o.day, a.Utilities.addClass(n, t.cssClasses.DAY), 1 === o.day && (this.options.weekStart === t.daysWeek.SUNDAY ? a.Utilities.setStyle(n, this.states.isRtl ? "margin-right" : "margin-left", i * (100 / Object.keys(t.daysWeek).length) + "%") : i === t.daysWeek.SUNDAY ? a.Utilities.setStyle(n, this.states.isRtl ? "margin-right" : "margin-left", (Object.keys(t.daysWeek).length - this.options.weekStart) * (100 / Object.keys(t.daysWeek).length) + "%") : a.Utilities.setStyle(n, this.states.isRtl ? "margin-right" : "margin-left", (i - 1) * (100 / Object.keys(t.daysWeek).length) + "%")), i !== t.daysWeek.SUNDAY && i !== t.daysWeek.SATURDAY || (a.Utilities.addClass(n, t.cssStates.IS_WEEKEND), o.isWeekend = !0), (this.states.isLocked || this.options.disabledDaysOfWeek && this.options.disabledDaysOfWeek.includes(i) || this.states.isDisablePastDays && +this.date.setHours(0, 0, 0, 0) <= +this.defaultDate.setHours(0, 0, 0, 0) - 1 || this.options.minDate && +this.minDate >= o.timestamp || this.options.maxDate && +this.maxDate <= o.timestamp) && (a.Utilities.addClass(n, t.cssStates.IS_DISABLED), o.isLocked = !0), this.options.disableDates && this.setDaysDisable(n, o), this.todayDate === o.timestamp && this.states.isTodayHighlight && (a.Utilities.addClass(n, t.cssStates.IS_TODAY), o.isToday = !0), this.daysSelected.find(function (e) {
                    e !== o.timestamp && new Date(new Date(e).setHours(0, 0, 0, 0)).getTime() !== o.timestamp || (a.Utilities.addClass(n, t.cssStates.IS_SELECTED), o.isSelected = !0)
                ...
                this.options.disableDates[0] instanceof Array ? this.options.disableDates.map(function (i) {
                    s.timestamp >= +new Date(i[0]) && s.timestamp <= +new Date(i[1]) && (a.Utilities.addClass(e, t.cssStates.IS_DISABLED), s.isLocked = !0)
                }) : this.options.disableDates.map(function (i) {
                    s.timestamp === +new Date(i) && (a.Utilities.addClass(e, t.cssStates.IS_DISABLED), s.isLocked = !0)
                })
            }, t.prototype.setDayHighlight = function (t, e) {
                var s = this,
                    i = function (i) {
                        a.daysHighlight[i].days[0] instanceof Array ? a.daysHighlight[i].days.map(function (a, n) {
                            e.timestamp >= new Date(new Date(a[0]).setHours(0, 0, 0, 0)).getTime() && e.timestamp <= new Date(new Date(a[1]).setHours(0, 0, 0, 0)).getTime() && s.setStyleDayHighlight(t, i, e)
                        }) : a.daysHighlight[i].days.map(function (a) {
                            new Date(new Date(e.timestamp).setHours(0, 0, 0, 0)).getTime() === new Date(new Date(a).setHours(0, 0, 0, 0)).getTime() && s.setStyleDayHighlight(t, i, e)
                        })
                    },
                    a = this;
                for (var n in this.daysHighlight) i(n)
            }, t.prototype.setStyleDayHighlight = function (e, s, i) {
                a.Utilities.addClass(e, t.cssStates.IS_HIGHLIGHT), this.daysHighlight[s].title && (i.tile = this.daysHighlight[s].title), this.daysHighlight[s].color && a.Utilities.setStyle(e, "color", this.daysHighlight[s].color), this.daysHighlight[s].backgroundColor && a.Utilities.setStyle(e, "background-color", this.daysHighlight[s].backgroundColor), i.isHighlight = !0
    ...
    }(o = e.MyModule || (e.MyModule = {})), window.HelloWeek = o.HelloWeek
}, function (t, e, s) {
    "use strict";
    Object.defineProperty(e, "__esModule", {
        value: !0
    ...
    var i = function () {
        ...
        return t.formatDate = function (t, e, s) {
            ...
            for (var e = {
                    ...
                    onSelect: function () {},
                    onClear: function () {}
                }, s = t, i = 0, a = Object.keys(s); i < a.length; i++) {
                var n = a[i];
                e[n] = s[n]
            }
            return e
